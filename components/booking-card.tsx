...
export function BookingCard({ hotelName, location, checkIn, checkOut, status, image }: BookingCardProps) {
  const statusColors = {
        ...
        <div className="flex flex-col flex-1">
          <CardContent className="p-4">
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="flex items-center text-sm">
                <div className="h-4 w-4 mr-2" /> {/* Spacer to align with icon above */}
                <div>
          ...
          <CardFooter className="p-4 pt-0 flex gap-2 mt-auto">
            <Button variant="outline" asChild className="flex-1">
              <Link href="/dashboard/bookings/details">View Details</Link>
            </Button>
            {status === "completed" && (
