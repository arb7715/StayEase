      ...
      <section className="relative w-full h-[600px] flex items-center justify-center">
        ...
        <div className="container relative z-10 flex flex-col items-center text-center">
          ...
          <p className="text-xl text-white mb-8 max-w-2xl">
            Discover amazing hotels and accommodations around the world at the best prices
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <Input type="number" placeholder="Guests" min={1} defaultValue={2} className="pl-10" />
                </div>
      ...
      <section className="container py-12">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Explore our handpicked selection of amazing places to stay</p>
          </div>
      ...
      <section className="bg-primary text-primary-foreground py-16">
        <div className="container text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied travelers who have found their ideal accommodations through StayEase.
          </p>
